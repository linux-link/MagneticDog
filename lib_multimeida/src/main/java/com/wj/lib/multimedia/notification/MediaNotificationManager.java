package com.wj.lib.multimedia.notification;
...
import com.wj.lib.multimedia.MusicLibrary;
...
public class MediaNotificationManager {
    ...
    private NotificationCompat.Builder buildNotification(@NonNull PlaybackStateCompat state,
        ...
        builder.setStyle(
                ...
                .setColor(ContextCompat.getColor(mContext, R.color.design_default_color_on_primary))
